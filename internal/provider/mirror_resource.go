...
import (
	...
	"github.com/nokia/eda/apps/terraform-provider-oam/internal/resource_mirror"
	"github.com/nokia/eda/apps/terraform-provider-oam/internal/tfutils"
)

const (
	create_rs_mirror = "/apps/oam.eda.nokia.com/v1alpha1/namespaces/{namespace}/mirrors"
	read_rs_mirror   = "/apps/oam.eda.nokia.com/v1alpha1/namespaces/{namespace}/mirrors/{name}"
	update_rs_mirror = "/apps/oam.eda.nokia.com/v1alpha1/namespaces/{namespace}/mirrors/{name}"
	delete_rs_mirror = "/apps/oam.eda.nokia.com/v1alpha1/namespaces/{namespace}/mirrors/{name}"
)

var (
	_ resource.Resource                = (*mirrorResource)(nil)
	_ resource.ResourceWithConfigure   = (*mirrorResource)(nil)
	_ resource.ResourceWithImportState = (*mirrorResource)(nil)
)
...
func (r *mirrorResource) Metadata(ctx context.Context, req resource.MetadataRequest, resp *resource.MetadataResponse) {
	resp.TypeName = req.ProviderTypeName + "_mirror"
}

func (r *mirrorResource) Schema(ctx context.Context, req resource.SchemaRequest, resp *resource.SchemaResponse) {
	resp.Schema = resource_mirror.MirrorResourceSchema(ctx)
}

func (r *mirrorResource) Create(ctx context.Context, req resource.CreateRequest, resp *resource.CreateResponse) {
	var data resource_mirror.MirrorModel
	...
	err = r.client.Create(ctx, create_rs_mirror, map[string]string{
	...
	err = r.client.Get(ctx, read_rs_mirror, map[string]string{
		"namespace": tfutils.StringValue(data.Metadata.Namespace),
...
func (r *mirrorResource) Update(ctx context.Context, req resource.UpdateRequest, resp *resource.UpdateResponse) {
	...
	err = r.client.Update(ctx, update_rs_mirror, map[string]string{
		"namespace": tfutils.StringValue(data.Metadata.Namespace),
		"name":      tfutils.StringValue(data.Metadata.Name),
	}, reqBody, &result)
...
func (r *mirrorResource) Delete(ctx context.Context, req resource.DeleteRequest, resp *resource.DeleteResponse) {
	...
	err := r.client.Delete(ctx, delete_rs_mirror, map[string]string{
		"namespace": tfutils.StringValue(data.Metadata.Namespace),
		"name":      tfutils.StringValue(data.Metadata.Name),
	}, &result)
