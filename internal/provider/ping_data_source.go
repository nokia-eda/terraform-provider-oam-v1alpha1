...
import (
	...
	"github.com/nokia/eda/apps/terraform-provider-oam/internal/datasource_ping"
...
const read_ds_ping = "/workflows/v1/oam.eda.nokia.com/v1alpha1/namespaces/{namespace}/pings/{name}"

var (
	_ datasource.DataSource              = (*pingDataSource)(nil)
	_ datasource.DataSourceWithConfigure = (*pingDataSource)(nil)
)
...
func (d *pingDataSource) Read(ctx context.Context, req datasource.ReadRequest, resp *datasource.ReadResponse) {
	...
	err = d.client.GetByQuery(ctx, read_ds_ping, map[string]string{
...
func (r *pingDataSource) Configure(_ context.Context, req datasource.ConfigureRequest, resp *datasource.ConfigureResponse) {
