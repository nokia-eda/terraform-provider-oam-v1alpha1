...
import (
	...
	"github.com/nokia/eda/apps/terraform-provider-oam/internal/resource_ping"
	"github.com/nokia/eda/apps/terraform-provider-oam/internal/tfutils"
)

const (
	create_rs_ping = "/workflows/v1/oam.eda.nokia.com/v1alpha1/namespaces/{namespace}/pings"
	read_rs_ping   = "/workflows/v1/oam.eda.nokia.com/v1alpha1/namespaces/{namespace}/pings/{name}"
	delete_rs_ping = "/workflows/v1/oam.eda.nokia.com/v1alpha1/namespaces/{namespace}/pings/{name}"
)

var (
	_ resource.Resource                = (*pingResource)(nil)
	_ resource.ResourceWithConfigure   = (*pingResource)(nil)
	_ resource.ResourceWithImportState = (*pingResource)(nil)
)
...
func (r *pingResource) Metadata(ctx context.Context, req resource.MetadataRequest, resp *resource.MetadataResponse) {
	resp.TypeName = req.ProviderTypeName + "_ping"
}

func (r *pingResource) Schema(ctx context.Context, req resource.SchemaRequest, resp *resource.SchemaResponse) {
	resp.Schema = resource_ping.PingResourceSchema(ctx)
}

func (r *pingResource) Create(ctx context.Context, req resource.CreateRequest, resp *resource.CreateResponse) {
	var data resource_ping.PingModel
	...
	err = r.client.Create(ctx, create_rs_ping, map[string]string{
	...
	err = r.client.Get(ctx, read_rs_ping, map[string]string{
		"namespace": tfutils.StringValue(data.Metadata.Namespace),
...
func (r *pingResource) Update(ctx context.Context, req resource.UpdateRequest, resp *resource.UpdateResponse) {
...
func (r *pingResource) Delete(ctx context.Context, req resource.DeleteRequest, resp *resource.DeleteResponse) {
	var data resource_ping.PingModel
	...
	err := r.client.Delete(ctx, delete_rs_ping, map[string]string{
		"namespace": tfutils.StringValue(data.Metadata.Namespace),
		"name":      tfutils.StringValue(data.Metadata.Name),
	}, &result)
...
func (r *pingResource) ImportState(ctx context.Context, req resource.ImportStateRequest, resp *resource.ImportStateResponse) {
