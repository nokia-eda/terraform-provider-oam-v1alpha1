...
import (
	...
	"github.com/nokia/eda/apps/terraform-provider-oam/internal/eda/utils"
...
var _ provider.Provider = (*oamProvider)(nil)

func New(ver string) func() provider.Provider {
	return func() provider.Provider {
		return &oamProvider{version: ver}
	}
}

type oamProvider struct {
	version string
}
...
func (p *oamProvider) Schema(ctx context.Context, req provider.SchemaRequest, resp *provider.SchemaResponse) {
...
func (p *oamProvider) Configure(ctx context.Context, req provider.ConfigureRequest, resp *provider.ConfigureResponse) {
...
func (p *oamProvider) Metadata(ctx context.Context, req provider.MetadataRequest, resp *provider.MetadataResponse) {
	resp.TypeName = "oam-v1alpha1"
	resp.Version = p.version
}

func (p *oamProvider) DataSources(ctx context.Context) []func() datasource.DataSource {
	return []func() datasource.DataSource{
		NewAppGroupDataSource,
		NewMirrorDataSource,
		NewMirrorListDataSource,
		NewPingDataSource,
		NewPingListDataSource,
		NewResourceListDataSource,
		NewTechSupportDataSource,
...
func (p *oamProvider) Resources(ctx context.Context) []func() resource.Resource {
