...
func TechSupportResourceSchema(ctx context.Context) schema.Schema {
	return schema.Schema{
		Attributes: map[string]schema.Attribute{
			...
			"kind": schema.StringAttribute{
				...
				Computed: true,
				Validators: []validator.String{
					stringvalidator.RegexMatches(regexp.MustCompile("^TechSupport$"), ""),
				},
				Default: stringdefault.StaticString("TechSupport"),
			},
			...
			"name": schema.StringAttribute{
				...
				MarkdownDescription: "name of the TechSupport",
			},
			"namespace": schema.StringAttribute{
				Optional:            true,
				Computed:            true,
			...
			"status": schema.SingleNestedAttribute{
				Attributes: map[string]schema.Attribute{
					"failed_nodes": schema.ListAttribute{
						ElementType:         types.StringType,
						Optional:            true,
						Computed:            true,
						...
						MarkdownDescription: "List of nodes failed to produce tech-support, it is populated in case of PartialSuccess\nItems in the list should be the names of the nodes, where tech-support failed",
					},
				...
				MarkdownDescription: "Result of the technical support package generation.",
			},
		},
	}
}
...
func (t StatusType) ValueFromObject(ctx context.Context, in basetypes.ObjectValue) (basetypes.ObjectValuable, diag.Diagnostics) {
	...
	failedNodesAttribute, ok := attributes["failed_nodes"]

	if !ok {
		diags.AddError(
			"Attribute Missing",
			`failed_nodes is missing from object`)

		return nil, diags
	}

	failedNodesVal, ok := failedNodesAttribute.(basetypes.ListValue)

	if !ok {
		diags.AddError(
			"Attribute Wrong Type",
			fmt.Sprintf(`failed_nodes expected to be basetypes.ListValue, was: %T`, failedNodesAttribute))
	}
...
type StatusValue struct {
	FailedNodes basetypes.ListValue   `tfsdk:"failed_nodes"`
...
func (v StatusValue) ToTerraformValue(ctx context.Context) (tftypes.Value, error) {
	...
	attrTypes["failed_nodes"] = basetypes.ListType{
		ElemType: types.StringType,
	}.TerraformType(ctx)
	...
	case attr.ValueStateKnown:
		...
		val, err = v.FailedNodes.ToTerraformValue(ctx)

		if err != nil {
			return tftypes.NewValue(objectType, tftypes.UnknownValue), err
		}

		vals["failed_nodes"] = val
...
func (v StatusValue) ToObjectValue(ctx context.Context) (basetypes.ObjectValue, diag.Diagnostics) {
	...
	var failedNodesVal basetypes.ListValue
	switch {
	case v.FailedNodes.IsUnknown():
		failedNodesVal = types.ListUnknown(types.StringType)
	case v.FailedNodes.IsNull():
		failedNodesVal = types.ListNull(types.StringType)
	default:
		var d diag.Diagnostics
		failedNodesVal, d = types.ListValue(types.StringType, v.FailedNodes.Elements())
		diags.Append(d...)
	}

	if diags.HasError() {
		return types.ObjectUnknown(map[string]attr.Type{
			"failed_nodes": basetypes.ListType{
				ElemType: types.StringType,
			},
...
func (v StatusValue) Equal(o attr.Value) bool {
	...
	if !v.FailedNodes.Equal(other.FailedNodes) {
		return false
	}
